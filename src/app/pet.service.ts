...
export class PetsService {
  ...
  getPets (): Observable<Pet[]> {
    // TODO: send the message _after_ fetching the pets
    this.messageService.add('PetService: fetched pets');
    return of (PETS);
  }

  /** GET Pets by id. Return `undefined` when id not found */
  ...
  addPet (pets: Pet): Observable<Pet> {
    return this.http.post<Pet>(this.petsUrl, pets, this.httpOptions).pipe(
